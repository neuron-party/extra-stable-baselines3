...
SelfBaseAlgorithm2 = TypeVar("SelfBaseAlgorithm2", bound="BaseAlgorithm2")
...
class BaseAlgorithm2(ABC):
    """
    Modified base class algorithm for supporting modified on policy algorithms
    """
