...
SelfSupervisedFinetuningPPO = TypeVar("SelfSupervisedFinetuningPPO", bound="SupervisedFinetuningPPO")


class SupervisedFinetuningPPO(BaseAlgorithm):
    """
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
           ...
           #  print(obs_bytes)
            ...
            #     self.trajectory_buffer[idx].append(obs.copy())
            # for idx, obsb in enumerate(obs_bytes):
            #     self.trajectory_bytes_buffer[idx].append(obsb.copy())
            self._last_obs = new_obs
            self._last_episode_starts = dones
            
            # bruh i havent been adding the actual states to the trajectory buffer this whole time
    ...
    def learn(
        self: SelfSupervisedFinetuningPPO,
        total_timesteps: int,
